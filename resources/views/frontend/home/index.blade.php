...
<!-- <div id="info">
    ...
    <!-- <h1 class="title">Seleccione una clasificación y registre su permuta.</h1> -->
<!-- </div> -->
<!--  -->
<section class='tl'>  
    <article>
      <figure>
        <h2 class="category_name">INMUEBLES</h2>
        <a href="{{ route('category',$categoria1) }}"><p>Ver productos</p></a> 
      </figure>
      <img alt src='imgs/1.png' />
    </article>
    <article>
      <figure>
        <h2 class="category_name">VEHICULOS</h2>
        <a href="{{ route('category',$categoria6) }}"><p>Ver productos</p></a> 
      </figure>
      <img alt src='imgs/2.png' />
    </article>
    <article>
      <figure>
        <h2 class="category_name">MAQUINARIAS</h2>
        <a href="{{ route('category',$categoria2) }}"><p>Ver productos</p></a> 
      </figure>
      <img alt src='imgs/6.png' />
    </article>
    <article style="visibility: hidden;">
      <figure>
        <h2 class="category_name">ELECTRONICA</h2>
        <a href="{{ route('category',$categoria3) }}"><p>Ver productos</p></a> 
      </figure>
      <img alt src='imgs/3.png' />
    </article>
    <article>
      <figure>
        <h2 class="category_name">COLECCIÓN Y ANTIGUEDADES</h2>
        <a href="{{ route('category',$categoria4) }}"><p>Ver productos</p></a> 
      </figure> 
    ...
    <article>
    <figure>
      <h2 class="category_name">MONEDAS, TITULOS Y VALORES</h2>
      <a href="{{ route('category',$categoria5) }}"><p>Ver productos</p></a> 
